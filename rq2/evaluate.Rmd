...
```{r}
ex_review_auc = getAUC(ex_review_model, data, target_var)
...
```{r}
ex_review_vars = getVariableSigAndSign(ex_review_model)

print(ex_review_vars)
```
...
```{r}
ex_social_auc = getAUC(ex_social_model, data, target_var)
...
```{r}
print(ex_review_vars[order(-ex_review_vars$Chisq),])
```
